...
pdf('fig1_inset.pdf')
p1 = qplot(V1,csize/1000000,data=y[V1%%5==0],xlab="K",ylab="Cluster Size (millions)") + theme_bw() + scale_x_continuous("K",breaks=break_vec)
...
p2 <- qplot(log10(k),log10(V1),data=plot_df,color=mod,xlab='log10(k)',ylab='log10(k-core size)') + 
