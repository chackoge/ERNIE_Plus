...
SELECT pc.relname, coalesce(obj_pt.spcname, db_pt.spcname) AS tablespace, pc.reltype, pc.reloftype, pc.relowner,
...
WITH cte AS (SELECT cc.conrelid,
               format(E',
...
SELECT pn.nspname AS schema, pc.relname AS table,
